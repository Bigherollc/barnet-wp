<?php
/* Template Name: System Listing Page */
        ...
        <div class="product-container" data-product>
            <div class="container" id="app">
                <com-container :isdarkmode="true">
                    <com-heading-group slot="left" title="Systems" desc="Beyond traditional emulsifiers, we focus on look and feel to make your products stand out in the marketplace."></com-heading-group>

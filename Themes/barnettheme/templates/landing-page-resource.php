                    ...
                    <div class="product__pageListing--colRight">
                        ...
                        <div class="product__wrapping --mg-top-lg">
                                                ...
                                                foreach($resourcefiltered as $resourceData) {
                                                    ...
                                                    <div class="component-related-video__col" data-slider-item><a
                                                        ...
                                                        <div class="component-related-video__content"><a
                                                            ...
                                                            <?php if ($resourceData['resource_media_type'] == 'video/mp4'&& isset($resourceData['resource_other_attribute']['length_formatted'])) {
                            ...
                            <div class="product__loadmore --mg-top-md">
                                <a class="btn btn-regular --dark-mode" href="<?php echo add_query_arg("action", 'listing', $current_url); ?>"
                                   title="<?php _e('See All Resources'); ?>" rel="stylesheet"
                                   data-see-more=""><?php _e('See All Resources'); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
